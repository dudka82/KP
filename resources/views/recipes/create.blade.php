                                        ...
                                        @foreach(old('ingredients') as $index => $ingredient)
                                            <div class="ingredient-group mb-2">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="ingredients[{{ $index }}][amount]" class="form-control ingredient-amount" style="margin-bottom:20px" placeholder="Количество" value="{{ $ingredient['amount'] ?? '' }}" required>
                                    ...
                                    @else
                                        <div class="ingredient-group mb-2">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="ingredients[0][amount]" class="form-control ingredient-amount" style="margin-bottom:20px" placeholder="Количество" required>
                                                <div class="input-group-append">
                                    ...
                                    @if(old('steps'))
                                        @foreach(old('steps') as $index => $step)
                                            <div class="step-group mb-3">
                                                ...
                                                <textarea name="steps[{{ $index }}][description]" class="form-control mb-2" style="margin-bottom:10px" rows="2" required>{{ $step['description'] }}</textarea>
                                                <input type="text" name="steps[{{ $index }}][image_url]" class="form-control mb-2" placeholder="URL изображения (необязательно)" value="{{ $step['image_url'] ?? '' }}">
                                            </div>
                                        @endforeach
                                    @else
                                        <div class="step-group mb-3">
                                            <label>Шаг 1</label>
                                            <textarea name="steps[0][description]" class="form-control mb-2" style="margin-bottom:10px" rows="2" required></textarea>
                                            <input type="text" name="steps[0][image_url]" class="form-control mb-2" placeholder="URL изображения (необязательно)">
                                        </div>
                                    @endif
                                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('add-step').addEventListener('click', function() {
            ...
            div.innerHTML = `<br>
                <label>Шаг ${index + 1}</label>
                <textarea name="steps[${index}][description]" class="form-control" style="margin-bottom:10px" rows="2"></textarea>
                <input type="text" name="steps[${index}][image_url]" class="form-control mb-2" placeholder="URL изображения (необязательно)">
