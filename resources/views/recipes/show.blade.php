...
<div class="container py-5">
    ...
    <div class="row">
        <!-- Основная колонка с контентом рецепта -->
        <div class="col-md-8">
            <!-- Изображение рецепта -->
            @if($recipe->image_url)
    ...
    <div class="comment-section mt-5">
        ...
        @else
            <div class="alert alert-info" style="background-color:#252525;border:none">
                <a href="{{ route('login') }}">Войдите</a>,<span style="color:#fff"> чтобы оставить комментарий</span>
            </div>
        @endauth
